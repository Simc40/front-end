import { DataGrid, ptBR, GridRowsProp, GridColDef, useGridApiRef } from '@mui/x-data-grid';
...
export const ForgeSyncronizeTable = ({columnRows, tableRows} : {columnRows: any,tableRows:any}) => {
