...
export const BIM = () => {
    ...
    const [elements, setElements] = useState<getElementsInterface>({
        elements: [],
        constructions: [],
        geometries: [],
        shapes: [],
        ...
        switch (page) {
            case page1:
                return (
                    <BimManageModels
                        BIM={listBIM}
                        constructions={elements.constructions}
                    />
                );
            case page2:
                return (
        ...
        return (
            <Container>
                ...
                <Main>
                    <SubPageContainer>
                        <SubPageButton
                            text="Gerenciar Modelos BIM"
                            path="/BIM/gerenciar_modelos"
                            selected={page === page1}
                        />
                        <SubPageButton
                            text="Visualizar Modelos BIM"
                            path="/BIM/visualizar_modelo_bim"
                            selected={page === page2}
                        />
                        <SubPageButton
                            text="Sincronizar Modelo BIM"
                            path="/BIM/sincronizar_modelo"
                            selected={page === page3}
                        />
                    </SubPageContainer>
