...
import { DashboardBIM } from "./DashboardBIM";
...
export const Dashboard = () => {
    ...
    useEffect(() => {
        ...
        errosApi()
            .getErros()
            .then(setErrors)
            .then(piecesApi().getPiecesMapByName)
            .then((map) => {
    ...
    const modifyChart = (constructionUid: string) => {
        ...
        if (errors[constructionUid] === undefined)
        ...
        Array.from(Object.values(errorsInConstruction))
            .flatMap((tag: any) => Object.values(tag))
            .forEach((error: any) => {
                qnt_erros_por_etapa[
                    array_etapas.indexOf(error.etapa_detectada)
                ]++;
            });
                                    ...
                                    <div className="table-responsive">
                                        <TableLeft className="display table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        {dashboardData.aco_perc}
                                                        %
                                                    </td>
                                                    <td>
                                                        {dashboardData.aco_kg}Kg
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </TableLeft>
                                        <TableLeft className="display table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        {
                                                            dashboardData.concreto_perc
                                                        }
                                                        %
                                                    </td>
                                                    <td>
                                                        {
                                                            dashboardData.concreto_kg
                                                        }
                                                        m³
                                                    </td>
                                                </tr>
