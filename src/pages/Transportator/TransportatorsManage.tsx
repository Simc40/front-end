...
export const TransportatorsManage = ({transportators} : {transportators:Transportator[] | undefined}) => {
    ...
    useEffect(() => {
        auth.setPath("Home → Gerenciamento → Transportadoras → Empresas → Gerenciar Transportadoras")
    ...
    const columns: GridColDef[] = [
        { field: 'nome_empresa', headerName: 'Transportadora', flex:2 , minWidth: 150},
    ...
    const onSubmit = () => {
        ...
        console.log(result)
        transportatorsApi().updateTransportator(result)
        .then(async () => {
            setIsLoading(false)
            return swal({
                icon: 'success',
        ...
        return (
            <form onSubmit={handleSubmit(onSubmit as any)}>
                <Section text='Gerenciar Status de Clientes.'>
                    ...
                    <TableManage columnRows={columns} tableRows={transportators} callback={handleRowEditCommit}/>
                </Section>
