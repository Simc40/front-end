...
import { ReportInspectionPage } from "./ReportInspectionPage";
    ...
    const pageContent = () => {
        return (
            <Container>
                ...
                <Main>
                    <SubPageContainer>
                        <SubPageButton text="Relatório Inspeção" selected={true}/>
                    </SubPageContainer>
                    
                    <ReportInspectionPage pieces={pieces} errors={errors} setPiece={setPiece} checklistHistory={checklistHistory}/>
                </Main>
            </Container>
        )
    }
