...
export const ShedsManage = ({sheds} : {sheds:Shed[] | undefined}) => {
    ...
    useEffect(() => {
        auth.setPath("Home → Gerenciamento → Galpões → Gerenciar Galpão")
    ...
    const columns: GridColDef[] = [
        { field: 'nome_galpao', headerName: 'Nome do Galpão', flex:2 , minWidth: 150},
        ...
        return (
            <form onSubmit={handleSubmit(onSubmit as any)}>
                <Section text='Gerenciar Status de Clientes.'>
                    ...
                    <TableManage columnRows={columns} tableRows={sheds} callback={handleRowEditCommit}/>
                </Section>
